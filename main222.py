...
def entry():
    ...
    # Read the CSV file
    df = pd.read_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\adv.csv")
    ...
    df.to_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\adv.csv", index=False)
...
# Read the CSV file into a DataFrame
    df = pd.read_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\bank.csv")

# Drop rows where all values are NaN (blank rows)
    df.dropna(how='all', inplace=True)

# Write the DataFrame back to a CSV file
    df.to_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\bank.csv", index=False)

    df2 = pd.read_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\adv.csv")
# Replace 0 with NaN (or another null representation)
    df2.replace(0, np.nan, inplace=True)
    df2.to_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\adv.csv", index=False)
    with open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\bank.csv", mode='r') as f20:
...
# Save the modified DataFrame back to a CSV file
    ...
    sumbms = 0
    with open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\bank.csv", mode='r') as f20:
        wr = csv.reader(f20, delimiter=',')
        for a5 in wr:
            if int(float(a5[4])) == int(float(bank_cho)):
                
                if count1>0:
                    if a5[3]=="FREG":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["Foreign Regsitered Articles Posted", a5[5], price1])
                if count2>0:
                    if a5[3]=="RP":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["Registered Parcel Posted", a5[5], price2])
                if (a5[3] == "DA RP"):
                    for r in data:
                        if r[0] == "Registered Parcel Posted":
                            r[2] = r[2] + a5[10]/1.1836
                if (a5[3] == "DA FR"):
                    for r in data:
                        if r[0] == "Foreign Registered Articles Posted":
                            r[2] = r[2] + a5[10]/1.1836
                if (a5[3] == "DA FRP"):
                    for r in data:
                        if r[0] == "Foreign Registered Parcel Posted":
                            r[2] = r[2] + a5[10]/1.1836
                if (a5[3] == "DA SP"):
                    for r in data:
                        if r[0] == "SPP Posted":
                ...
                if (a5[3] == "DA FS"):
                    for r in data:
                        if r[0] == "Foreign Speed Article Posted":
                            r[2] = r[2] + a5[10]/1.1836
                if (a5[3] == "DA FS"):
                    for r in data:
                        if r[0] == "Foreign Speed Article Posted":
                ...
                if count3>0:
                    if a5[3]=="FRP":
                        ...
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["Foreign Registered Parcel Posted", a5[5], price3])
                if count4>0:
                    if a5[3]=="BMS":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["BMS Posted", sumbms, price4])
                if count5>0:
                    if a5[3]=="NBMS":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["NBMS Posted", a5[5], price5])
                if count6>0:
                    if a5[3]=="DP":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["DP Posted", a5[5], price6])
                if count7>0:
                    if a5[3]=="PC":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["PC Posted", a5[5], price7])
                if count8>0:
                    if a5[3]=="BP":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["BP Posted", a5[5], price8])
                if count9>0:
                    if a5[3]=="FORD":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["FORD Posted", a5[5], price9])
                if count10>0:
                    if a5[3]=="ILC":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["ILC Posted", a5[5], price10])
                if count11>0:
                    if a5[3]=="SPP":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["SPP Posted", a5[5], price11])
                if count12>0:
                    if a5[3]=="FSPEED":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
                        count15+=1
                        data.insert(16, ["Foreign Speed Article Posted", a5[5], price12])
                if count13>0:
                    if a5[3]=="RILC":
                        print("Hi")
                        sumbms = sumbms + float(a5[5])
    ...
    with open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\comp.csv", mode='r') as f:
        wr = csv.reader(f, delimiter=',')
        n = sum(1 for _ in wr)  # Count the number of rows
    f= open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\comp.csv", mode='r')
    wr = csv.reader(f, delimiter=',')
    ...
    f1 = open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\bank.csv", mode='r')
    f2 = open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\adv.csv", mode = 'r+')
    wr2 = csv.reader(f2)
    wr1 = csv.reader(f1)
    adv2=0.0
    k=0
    ...
    closing=data[27+k][2]
    csv_file_path = r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\adv.csv"
...
# Define the bank_cho and the new balance value
    ...
    with open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\post_details_ %s .csv"%(bank_cho), mode='w', newline='') as file:
...
def daily():
    ...
    window7.destroy()
    f = open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\adv.csv", mode="r")
    wr = csv.reader(f, delimiter=',')
    for a in wr:
        if a[0]==bank_cho:
            balance = a[1]
# Read the CSV file
    df = pd.read_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\dailybalance.csv", index_col=0)
...
# Write the DataFrame back to the CSV file
    df.to_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\dailybalance %s.csv"%{bank_cho})
def company_daily():
...
def comp_det():
    ...
    image = Image.open("C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\logo.png")
    ...
    image2 = Image.open("C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\india-post.png")
...
def add_save():
    ...
    pan = txt24.get()
    bal = txt25.get()
    f=open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\comp.csv", mode='a')
...
# Open the CSV file for reading
    with open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\comp.csv", mode="r", newline='') as file:
        # Create a CSV reader
    ...
    with open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\comp.csv", mode="w", newline='') as file:
        # Create a CSV writer
        writer = csv.writer(file)
...
def save_to_csv():
    ...
    try:
        df = pd.read_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\Book1.csv")
    ...
    df.to_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\Book1.csv", index=False)
...
def art_submit():
    ...
    frank = combo3.get()
    today = date.today()
    list1=[0,today, frank, prod, bank_choice, art, 0, rate_art, 0, tax, art*rate_art, 0, art*tax, art*rate_art*0.18, sc*art*0.18 , sc*art, sc, weight]
    f1=open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\bank.csv", mode='a')
    ww=csv.writer(f1)
    ww.writerow(list1)
    f1.close()
...
def article():
    ...
    df = pd.read_excel(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\ %s.xlsx"%(today_date))
    df = df.iloc[1:]
    new_df = df[['DATE', 'FM.NO', 'PRODUCT', 'DC', 'No of Articles', 'RATE', 'TAX RATE', 'Postage', 'Service tax and Edn.cess franked in RMFS', 'TAX (18%)', 'TOTAL S.Charge (PICKUP,STICKER,CLICK)', 'S.Charge per article', 'WEIGHT']]
    new_df.columns = ['date', 'frankie', 'article', 'dc', 'no of articles', 'rate', 'tax rate', 'postage', 'st', 'tax 18%', 'tax on sc', 'sc', 'service charge/art', 'weight']
    new_df.insert(0, 'Unnamed', 0)
    new_df.insert(6, 'Unnamed', 0)
    new_df.insert(8, 'Unnamed', 0)
    new_df.insert(11, 'Unnamed', 0)
    new_df.to_excel(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\ %s refined.xlsx"%(today_date), index=False)
...
def add_attendance_entry_exit():
    ...
    if entry_time == '0' and exit_time == '0':
        df = pd.read_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\attendance.csv")
    ...
    # Write the updated DataFrame back to the CSV file
        df.to_csv(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\attendance.csv", index=False)
    # Read the CSV file into a DataFrame
    else:
...
def attendance():
    ...
    f1 = open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\attendance.csv", mode="r")
