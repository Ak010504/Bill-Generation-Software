...
def article():
    ...
    combo1['values']=("REG","FREG","RP", "FRP", "DA R", "DA RP", "DA FR","DA FRP","ORD", "BMS", "NBMS","DP", "PC", "BP", "FORD", "ILC", "DP DA", "SPEED", "SPP", "F SPEED", "DA S", "DA SP", "DA FS", "RILC", "RPP")
    ...
    f1 = open(r"C:\\Users\\Acer\\Desktop\\BILL GENERATION APP\\Book1.csv", mode="r")
